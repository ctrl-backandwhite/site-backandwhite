...
import { SellingchartComponent } from './shared/sellingchart/sellingchart.component';
...
@Component({
    ...
    imports: [PagetitleComponent, CommonModule, ReactiveFormsModule, SimplebarAngularModule, TabsModule, NgApexchartsModule,SellingchartComponent,BsDropdownModule]
})
/**
