...
var NgTranscludeDirective = class _NgTranscludeDirective {
...
var TabsetConfig = class _TabsetConfig {
  constructor() {
    this.type = "tabs";
...
var TabsetComponent = class _TabsetComponent {
  ...
  insertTabByOrder(tab) {
    ...
    for (let i = 0; i < this.tabs.length; i++) {
      ...
      if (existingTab.tabOrder !== void 0 && tab.tabOrder !== void 0 && tab.tabOrder < existingTab.tabOrder) {
        insertIndex = i;
        break;
      }
      if (existingTab.tabOrder === void 0) {
        insertIndex = i;
        break;
      }
    }
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
      ...
      dependencies: [NgClass, NgForOf, NgTranscludeDirective, NgIf],
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TabsetComponent, [{
    ...
    args: [{
      selector: "tabset",
      standalone: true,
      imports: [NgClass, NgForOf, NgTranscludeDirective, NgIf],
...
var TabHeadingDirective = class _TabHeadingDirective {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
//# sourceMappingURL=chunk-36X3QJLK.js.map
