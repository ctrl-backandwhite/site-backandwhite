...
function run(view, from2, to, text2, rules, plugin) {
  ...
  for (let i = 0; i < rules.length; i++) {
    ...
    if (!match || match[0].length < text2.length)
      continue;
...
function DropdownComponent_div_4_button_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(8, _c6, item_r2 === ctx_r2.activeItem, ctx_r2.disabledItems.includes(item_r2)))("ariaLabel", \u0275\u0275pipeBind1(1, 4, ctx_r2.getName(item_r2)));
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    template: function InsertCommandComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275domProperty("disabled", ctx.disabled)("innerHTML", \u0275\u0275pipeBind1(1, 6, ctx.html), \u0275\u0275sanitizeHtml)("title", \u0275\u0275pipeBind1(2, 8, ctx.getTitle(ctx.name)))("ariaLabel", \u0275\u0275pipeBind1(3, 10, ctx.getTitle(ctx.name)));
      }
    },
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    template: function ToggleCommandComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275domProperty("disabled", ctx.disabled)("innerHTML", \u0275\u0275pipeBind1(1, 8, ctx.html), \u0275\u0275sanitizeHtml)("title", \u0275\u0275pipeBind1(2, 10, ctx.getTitle(ctx.name)))("ariaLabel", \u0275\u0275pipeBind1(3, 12, ctx.getTitle(ctx.name)));
      }
    },
    dependencies: [AsyncPipe, SanitizeHtmlPipe],
    encapsulation: 2
...
//# sourceMappingURL=chunk-2VAAR5CT.js.map
